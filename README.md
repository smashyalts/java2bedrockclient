...
- **[Oraxen](https://github.com/oraxen/oraxen)**, **[Nexo](https://docs.nexomc.com/)**, **[ItemsAdder](https://itemsadder.devs.beer/)**, **[CraftEngine](https://github.com/Xiao-MoMi/craft-engine)**, **[HMCCosmetics](https://github.com/Hibiscus-MC/HMCCosmetics)** — config formats parsed for base items, display names, furniture and cosmetics.
